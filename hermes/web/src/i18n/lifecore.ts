...
export const enLc: LifecoreTranslations = {
  ...
  pair: {
    ...
    subtitle:
      "Enter the 8-character pairing code to register this browser as your device.",
    baseLabel: "Server",
    codeLabel: "Pairing code",
    codePlaceholder: "8 characters (letters & digits, valid for 10 minutes)",
    ...
    needCode: "Pairing code must be 8 characters (letters & digits)",
...
export const zhLc: LifecoreTranslations = {
  ...
  pair: {
    title: "LifeCore 设备配对",
    subtitle: "输入 8 位字母+数字配对码，把这个浏览器注册为你的设备。",
    baseLabel: "服务器",
    codeLabel: "配对码",
    codePlaceholder: "8 位字母+数字（10 分钟内有效）",
